    ...
    public partial class DeletePatientWithBadOdataCalls_UT
    {
        ...
        public void DeletePatientWithBadFilterOdataCalls()
        {
            using (Aes aes = Aes.Create())
            {
                ...
                deletePatientWithBadOdata_ExpectedOutcomeEquals(ref apiHelperObject, queryValue, @"Invalid input parameters - supplied odata doesn't match expected format.");
                ...
                deletePatientWithBadOdata_ExpectedOutcomeEquals(ref apiHelperObject, queryValue, @"Invalid statement in request : $filter=PatLastName in (""APIPatientLastName"",)");

                Thread.Sleep(3000);

                queryValue = @"$filter=PatLastName eq \""APIPatientLastName\"" junk PatLastName eq \""APIPatientLastName\""";

                deletePatientWithBadOdata_ExpectedOutcomeEquals(ref apiHelperObject, queryValue, @"Invalid input parameters - supplied odata (PatLastName eq ""APIPatientLastName"" junk PatLastName eq ""APIPatientLastName"") contains unescaped double quote.");
                ...
                deletePatientWithBadOdata_ExpectedOutcomeEquals(ref apiHelperObject, queryValue, @"Invalid input parameters - Quoted items in odata in list are not in correctly listed form (PatLastName in (APIPatientLastName))");

                Thread.Sleep(3000);

                queryValue = @"$filter=PatLastName in (\""APIPatientLastName\"",\""test)";

                deletePatientWithBadOdata_ExpectedOutcomeEquals(ref apiHelperObject, queryValue, @"Invalid input parameters - quotes are not escaped properly.");
                ...
                deletePatientWithBadOdata_ExpectedOutcomeEquals(ref apiHelperObject, queryValue, @"Invalid statement in request : $filter=Patfirstname in (""this"", ""that"",)");
                ...
                deletePatientWithBadOdata_ExpectedOutcomeEquals(ref apiHelperObject, queryValue, @"Invalid input parameters - Quoted items in odata in list are not in correctly listed form (patid in (a,b))");
