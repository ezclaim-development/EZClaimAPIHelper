    ...
    public partial class DeletePatientWithBadOdataCalls_UT
    {
        ...
        public void DeleteePatientWithBadJoinWithFilterOdataCalls()
        {
            using (Aes aes = Aes.Create())
            {
                ...
                deletePatientWithBadOdata_ExpectedOutcomeEquals(ref apiHelperObject, queryValue, @"Invalid input parameters - Quoted items in odata in list are not in correctly listed form (Patid in (1, a))");
                ...
                deletePatientWithBadOdata_ExpectedOutcomeEquals(ref apiHelperObject, queryValue, @"Invalid input parameters - Quoted items in odata in list are not in correctly listed form (Patid in (null))");
            }
        }
    }
}
