    ...
    public partial class UpdatePatientWithBadOdataCalls_UT
    {
        ...
        public void UpdatePatientWithBadJoinWithFilterOdataCalls()
        {
            using (Aes aes = Aes.Create())
            {
                ...
                patientsObject = new();
                patientsObject.Add("patfirstname", "test");
                updatePatientWithBadOdata_ExpectedOutcomeEquals(ref apiHelperObject, queryValue, patientsObject, @"Invalid input parameters - Quoted items in odata in list are not in correctly listed form (Patid in (1, a))");
                ...
                patientsObject = new();
                patientsObject.Add("patfirstname", "test");
                updatePatientWithBadOdata_ExpectedOutcomeEquals(ref apiHelperObject, queryValue, patientsObject, @"Invalid input parameters - Quoted items in odata in list are not in correctly listed form (Patid in (null))");
            }
        }
    }
}
