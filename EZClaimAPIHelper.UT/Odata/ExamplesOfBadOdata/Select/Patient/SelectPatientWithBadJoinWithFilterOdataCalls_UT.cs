...
namespace EZClaimAPIHelper.UT
{
    public partial class SelectPatientWithBadOdataCalls_UT
    {
        ...
        public void SelectPatientWithBadJoinWithFilterOdataCalls()
        {
            using (Aes aes = Aes.Create())
            {
                ...
                selectPatientWithBadOdata_ExpectedOutcomeEquals(ref apiHelperObject, queryValue, @"Invalid input parameter : (=Patid eq 1). Query can contain 'select' or 'filter' or 'ids' or 'orderby' or 'top' or 'join')");

                Thread.Sleep(3000);

                queryValue = @"$join=LEFT Claim ClaPatFID EQ Patient PatID;$filter=Patid in (1, a)";

                selectPatientWithBadOdata_ExpectedOutcomeEquals(ref apiHelperObject, queryValue, @"Invalid input parameters - Quoted items in odata in list are not in correctly listed form (Patid in (1, a))");
                ...
                selectPatientWithBadOdata_ExpectedOutcomeEquals(ref apiHelperObject, queryValue, @"Invalid input parameters : asdf");
                ...
                selectPatientWithBadOdata_ExpectedOutcomeEquals(ref apiHelperObject, queryValue, @"Invalid input parameters - Quoted items in odata in list are not in correctly listed form (Patid in (null))");
            }
        }
    }
}
